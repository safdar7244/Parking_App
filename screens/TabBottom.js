...
//   },[index])
  return (
      ...
      <Tab indicatorStyle={{backgroundColor:"white"}}  value={index} onChange={setIndex} >
        ...
        <Tab.Item icon={ <Icon name="confirmation-number"  onPress={()=> {props.navigate.navigate('Tickets')}} size={30} color="#5EA0EE"/>} buttonStyle={styles.tileCont} titleStyle={styles.tileButton} title={data["Ticket"][settings]} />
        <Tab.Item 
        onPressIn={()=>{
